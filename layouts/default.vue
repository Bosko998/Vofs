<template>
    ...
    <div class="absolute inset-0 bg-[radial-gradient(circle,white_1px,transparent_2px)] opacity-0 animate-pulse animation-delay-[3s] transform scale-[0.3] translate-x-[50px] translate-y-[150px]"></div> -->
      <LazyAppHeader />
      <slot />
      <LazyAppFooter />
    </div>
